...
const Termsconditions = () => {
  ...
  <div className="forChart termspage">
    <div className="rw">
      ...
      <p>
        By accessing or using A3 Satta you agree to these Terms & Conditions
    ...
    <div className="rw">
      ...
      <p>
        Content on A3 Satta (text, images, logos, charts and code) is owned or
    ...
    <div className="rw">
      ...
      <p>
        A3 Satta provides informational content about results and charts only.
    ...
    <div className="rw">
      ...
      <p>
        📧 <strong>support@A3satta.com</strong>
        <br /> 🌐
        <a href="https://www.A3satta.com/">
          <strong>https://www.A3satta.com</strong>
        </a>
      </p>
    </div>
    <div className="rw">
